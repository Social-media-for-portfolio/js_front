...
const InterestCard = ({ interests, setInterests }) => {
  ...
  return (
    <div className="mx-3 d-flex justify-content-around">
      <div className="d-flex flex-column interest-card">{section1}</div>
      <div className="d-flex flex-column interest-card">{section2}</div>
      <div className="d-flex flex-column interest-card">{section3}</div>
      <div className="d-flex flex-column interest-card">{section4}</div>
      <div className="d-flex flex-column interest-card">{section5}</div>
    </div>
  );
};
